...
export function AccountCard({ account, onClick }: AccountCardProps) {
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="flex w-full cursor-grab items-center gap-4 rounded-xl bg-surface-container-low p-4 text-left transition-all active:scale-[0.99] active:cursor-grabbing"
    >
      <div
